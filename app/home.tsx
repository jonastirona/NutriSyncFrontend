          ...
          <Animated.View style={{ transform: [{ translateX }] }}>
            <ScrollView style={localStyles.scrollView}>
              <View style={styles.circleContainer}>
                <PercentageCircle label="Protein" percentage={40} />
                <PercentageCircle label="Carbs" percentage={60} />
                <PercentageCircle label="Fat" percentage={110} />
              </View>
              <PercentageBar label="Calorie Goal" percentage={80} />
              <FoodLog />
